<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.Master" AutoEventWireup="true" CodeBehind="registernow.aspx.cs" Inherits="YPortal.Web.programs.sports.registernow" %>
        ...
        <div class="custom-container">
            <div data-ride="carousel" data-interval="false" class="carousel slide" id="carousel-example-captions">
                <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#carousel-example-captions"><a href="#sportsregistration" onclick='SpecialRedirectPartTwo("sportsregistration")' data-toggle="tab">
                        <img src="../../App_Style/images/banner/thumbnails/programs/sports/register-now.png" />
                        <span>Register Now 
                        </span></a></li>
                </ol>
                <div class="carousel-inner">
                    <div class="item active">
                        <img alt="More than a  membership" data-src="holder.js/900x500/auto/#777:#777" src="../../App_Style/images/banner/sports/register-now.png">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tab-content">
                        <div class="tab-pane active" id="sportsregistration">
                            <div class="content-area-bg">
                                <ul class="nav nav-tabs responsive hidden-xs hidden-sm" id="myTab">
                                    <li class="active"><a href="#home" data-toggle="tab">YOUTH & ADULT SPORTS</a></li>
                                    <li><a href="#profiles" data-toggle="tab">SPORTS CLINICS </a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home">
                                        <div class="panel-heading visible-xs visible-sm">
                                            <div class="panel-title"><a href="#collapse-how-to" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">YOUTH & ADULT SPORTS</a></div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>Registration for youth and adult sports are available online or in person at any Family Center Y. </p>
                                                                ...
                                                                <p><b>2014 SESSION & REGISTRATION DATES</b></p>
                                                                ...
                                                                <p>STEP 1	   Click the purple REGISTER NOW button</p>
                                                                <p>STEP 2     Click the green LOGIN button under the Easy to Enroll logo and click the appropriate link under First Time Users</p>
                                                                <p>STEP 3     Fill in the requested information and click the SUBMIT button. If you have a membership card, you will be asked to type in the access code from the back of your membership. The access number and date of birth must be that of the primary member.</p>
                                                                <p>STEP 4     Once your request has been processed, you will receive an email.  At that point, you’re free to register online for any available Y program! </p>
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <div class="side-bar">
                                                                <a href="" data-toggle="modal" data-target=".bs-example-modal-lg" class="common-btn btn-velvet"><span class="btn-velvet-border">Register Now</span></a>
                                    ...
                                    <div class="tab-pane " id="profiles">
                                        <div class="panel-heading visible-xs visible-sm">
                                            <div class="panel-title"><a href="#collapse-how-to1" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">SPORTS CLINICS </a></div>
                                        </div>
                                        <div class="panel panel-default">
