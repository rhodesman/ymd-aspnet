<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.Master" AutoEventWireup="true" CodeBehind="catonsville-baltimore-county.aspx.cs" Inherits="YPortal.Web.locations.preschool.catonsville_baltimore_county" %>
        ...
        <li data-slide-to="2" data-target="#carousel-example-captions" class=""> <a href="#messagess" data-toggle="tab"><img src="App_Style/images/banner/inner-page-banner/indicator-01.png"> <span> Youth Sports </span></a> </li>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <img alt="More than a  membership" data-src="holder.js/900x500/auto/#666:#666" src="../../App_Style/images/banner/location/preschools/catonsville.png">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tab-content">
                        <div class="tab-pane active" id="preschoolcatonsville">
                                            ...
                                            <div style="height: auto;" class="panel-collapse in" id="collapse-how-to">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                <h2 class="title-02">Y Preschool in Catonsville</h2>
                                                                <address>
                                                                    850 S. Rolling Road                    
                                                                    <br>
                                                                ...
                                                                <br class="clear">
                                                                <h3 class="title-03">Betty Sterner</h3>

                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <a class="img-thumbnail-box" href="">
                                                                            <img src="../../App_Style/images/directors/betty-sterner.png" class="img-thumbnail">
                                                                        </a>
                                                                    </div>
                                                                </div>

                                                                <a href="mailto:bettysterner@ymaryland.org">bettysterner@ymaryland.org</a>

                                                                <br>
                                                                <br>
                                                                <p>Hello! My name is Betty Sterner and I am the Center Director at the Y Preschool in Catonsville. I hold an Associate’s Degree in Early Childhood Education from CCBC-Catonsville. I am the mother of three and the grandmother of seven. I understand the importance of making sure our children are exposed to a safe, loving, and educational preschool environment. With over 25 years of experience, I am committed to making sure our school exceeds the expectations of our families and the community that we are privileged to serve.</p>
                                                                <p>With an average tenure of nine years, our preschool teaching team is dedicated to helping every student reach their fullest potential in spirit, mind and body.  Our students are assessed three times a year so that teachers can implement individualized curriculum experiences that meet the needs of every student. </p>
                                                                <p>
                                                                    To see how the Y Preschool in Catonsville can make a positive impact on the educational future of your child, please contact us to set up a tour. We look forward to hearing from you!
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="side-bar">
                                                                ...
                                                                <a href="mailto:bettysterner@ymaryland.org" class="common-btn btn-velvet"><span class="btn-velvet-border">Request a Tour Today</a>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><strong>Half-day</strong> PreK (MWF 9:30 am - 1:30 pm) for ages 3 - 5</li>
                                                                    <li>Before & After School Enrichment for ages 5 - 12. Serving students from Arbutus Elementary/Middle and Catonsville, Hillcrest, Relay and Halethorpe elementary schools. Transportation provided.</li>

                                                                </ul>
                                                                <p>
                                                                    Y Preschool is a trusted program that has provided educational and developmental support to children and families for over 160 years. Our preschool program combines 
                                                                a safe and happy educational environment with a curriculum designed to stimulate intellectual, emotional, and physical growth. Each day you will be provided with 
                                                                ...
                                                                teach the critical skills needed for your child to succeed in kindergarten and beyond.
                                                                </p>
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <div class="side-bar">
                                                                <a href="mailto:bettysterner@ymaryland.org" class="common-btn btn-velvet"><span class="btn-velvet-border">Request a Tour Today</span></a>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                <p>
                                                                    The most important goal of our curriculum is to help children become enthusiastic learners. This means encouraging children to be active and creative 
                                                                    explorers who are not afraid to try out their ideas and to think their own thoughts. We’re teaching them how to learn and allowing them to learn at their 
                                                                    own pace and in the ways that are best for them. We’re instilling good habits and attitudes, character development, and a positive sense of themselves, 
                                                                ...
                                                                <p>
                                                                    ...
                                                                    individual needs of students; and health and safety. With this in mind, the Y of Central Maryland has chosen to use the Creative Curriculum and Core Knowledge Preschool Curriculum at all of our Y Preschool programs. 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>The percentage of our Y preschool children fully ready for kindergarten (based on the May 2013 MMSR assessment) is 87%.                                                                                                </p>
                                                                <p>2008 - MSDE Accreditation                                                                                                                                                                                                  </p>
                                                                <p>2004 - NAEYC Accreditation                                                                                                                                                                                                     </p>
                                                                <%--<div class="row">
                                                                    <div class="col-md-6">
                                                                        <a class="img-thumbnail-box" href="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <a target="_blank" href="pdf/Catonsville_PS_packet_14-15.pdf">2014/2015 Y Preschool in Catonsville Registration Packet </a>
                                                                <br />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p><strong><i>"The center is beautifully run, organized, friendly and I feel that my children are well cared for."</i></strong> - Erin, October 2013</p>
                                                                <p>
                                                                    <strong><i>"Nothing but positive experiences! Absolutely love every aspect!"</i></strong> - Dominique, October 2013
                                                                </p>

                                                                <p><strong><i>"Great staff and great learning!"</i></strong> - Anthony, October 2013</p>
