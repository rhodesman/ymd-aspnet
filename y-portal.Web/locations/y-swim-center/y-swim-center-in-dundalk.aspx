<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.Master" AutoEventWireup="true" CodeBehind="y-swim-center-in-dundalk.aspx.cs" Inherits="YPortal.Web.locations.y_swim_center.y_swim_center_in_dundalk" %>
        ...
        <li data-slide-to="2" data-target="#carousel-example-captions" class=""> <a href="#messagess" data-toggle="tab"><img src="App_Style/images/banner/inner-page-banner/indicator-01.png"> <span> Youth Sports </span></a> </li>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <img alt="More than a  membership" data-src="holder.js/900x500/auto/#666:#666" src="../../App_Style/images/banner/location/dundalk.png">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tab-content">
                        <div class="tab-pane active" id="familycenterysdundalk">
                            <div class="content-area-bg">
                                <ul class="nav nav-tabs responsive hidden-xs hidden-sm" id="myTab">
                                    ...
                                    <li><a href="#Accreditations" class="" data-toggle="tab">Schedules</a></li>
                                    <li><a href="#settings" class="" data-toggle="tab">Get Involved</a></li>
                                    <li><a href="#Give-Back" class="" data-toggle="tab">Policies</a></li>
                                ...
                                <div class="tab-content">
                                            ...
                                            <div style="height: auto;" class="panel-collapse in" id="collapse-how-to">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                <h2 class="title-02">Y Swim Center in Dundalk</h2>
                                                                <address>
                                                                    120 Trading Pl.                    
                                                                    <br>
                                                                    Dundalk, MD 21222    
                                                                ...
                                                                <h3 class="title-03"><strong>Betsy Kulp</strong><br />
                                                                    </h3>
                                                                <a class="img-thumbnail-box" href="">
                                                                    <img src="../../App_Style/images/directors/betty-kulp.png" class="img-thumbnail">
                                                                </a>

                                                                  <ul>
                                                                    <li>Regional Swim Director: <a href="mailto:betsykulp@ymaryland.org">Betsy Kulp</a></li>
                                                                      <li>Director of Member Services: <a href="mailto:lindahahn@ymaryland.org">Linda Hahn</a></li>
                                                                      <li>Swim Director: <a href="mailto:shannonhale@ymaryland.org">Shannon Hale</a></li>
                                                                </ul>
                                                                <br class="clear" />
                                                                <br />
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>3.9 feet to 9.5 feet deep   </li>
                                                                    <li>Men's/women's locker rooms</li>
                                                                    <li>Family locker room</li>
                                                                </ul>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                <p>
                                                                    We offer a variety of programs for all ages. Our programs are specifically designed to encourage positive growth and development in our youth, motivate you to achieve a healthy lifestyle and advocate community building and social responsibility at all levels.
                                                                </p>
                                                                <p><strong>Health & Well-being</strong></p>
                                                                <p>
                                                                    The Y Swim Center in Dundalk offers a wide variety of swim programs including parent/child lessons, youth lessons, teen/adult lessons, water fitness, community swim times and much more!
                                                                </p>
                                                                <p><strong>Birthday Parties</strong></p>
                                                                <p>Celebrate your special day at the Y! Call 410-285-7616 for party details, rates and more!</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5">
                                                            <div class="side-bar">
                                    ...
                                    <div class="tab-pane " id="Accreditations">
                                        <div class="panel-heading visible-xs visible-sm">
                                            <div class="panel-title"><a href="#collapse-souurces-011" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">Schedules</a></div>
                                        </div>
                                        <div class="panel panel-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                    <li><a href="../family-center-ys/pdf/schedule/y-swim-center-in-dundalk/Dundalk-pool-v2.pdf" target="_blank">Open/Lap Swim (spring II)</a></li>
                                                                    <li><a href="../family-center-ys/pdf/Dundalk-OpenLapSwim-Summer_14.pdf" target="_blank">Open/Lap Swim (summer)</a></li>
                                                                </ul>
                                    ...
                                    <div class="tab-pane " id="settings">
                                        <div class="panel-heading visible-xs visible-sm">
                                            <div class="panel-title"><a href="#collapse-sources" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">Get Involved</a></div>
                                        </div>
                                        <div class="panel panel-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>
                                                                    As a cause-driven, charitable organization, we rely on the support of our community to help us achieve our mission of developing the full potential of every individual 
                                                            through programs that build healthy spirit, mind and body for all.                    
                                                                ...
                                                                <p>
                                                                    Your donations stay in your community if you choose, and support children and families who otherwise couldn't afford enriching Y experiences. <a href="https://www.stayclassy.org/checkout/donation?eid=22445">Please consider making a donation today</a>. 
                                                                Any amount helps!
                                                                </p>
                                                                ...
                                                                <p>The primary responsibility of CLB members is to help engage the community in the Y's charitable mission to support children and families in need in Baltimore County so they may benefit from quality Y experiences they otherwise couldn't afford.</p>

                                                                
                                                                <p>If you're interested in becoming a volunteer, please contact Betsy Kulp at <a href="mailTo:betsykulp@ymaryland.org">betsykulp@ymaryland.org</a>.</p>
                                    ...
                                    <div class="tab-pane " id="Give-Back">
                                        <div class="panel-heading visible-xs visible-sm">
                                            <div class="panel-title"><a href="#collapse-sources-05" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">Policies</a></div>
                                        </div>
                                        <div class="panel panel-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">                                                            
                                                            ...
                                                            <div class="main-body">
                                                                ...
                                                                <p>The partial list of policies below help ensure that everyone who enters our center has a positive Y experience. For a complete list, please see the <a href="../family-center-ys/pdf/MEMBERSHIP-How-to-Become-a-Member-New-Member-Handbook(3).pdf" target="_blank">New Member Handbook.</a></p>
                                                                ...
                                                                <ul>
                                                                   ...
                                                                   <p></panel> <strong>Pool Youth Age Policy (partial)</strong>   </p>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>the individual can stand with both feet flat on the bottom of the pool and </li>
                                                                    <li>the individual can right themselves after they have leaned backwards lifting both feet off  the bottom of the pool and coming back to a standing position with feet flat on the bottom of the pool. </li>

                                                                </ul>
                                                                <p>
                                                                    <i>If you do not pass the shallow water test, you can still get in the water if you wear a coast guard approved life vest (available at the Y) and you have a parent within arm's
                                                                     reach. </i>                                
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>water was above their head as they jumped in the deep end and   </li> 
