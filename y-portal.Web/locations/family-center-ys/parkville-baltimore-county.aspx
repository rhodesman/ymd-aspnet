<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.Master" AutoEventWireup="true" CodeBehind="parkville-baltimore-county.aspx.cs" Inherits="YPortal.Web.locations.family_center_ys.parkville_baltimore_county" %>
        ...
        <li data-slide-to="2" data-target="#carousel-example-captions" class=""> <a href="#messagess" data-toggle="tab"><img src="App_Style/images/banner/inner-page-banner/indicator-01.png"> <span> Youth Sports </span></a> </li>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <img alt="More than a  membership" data-src="holder.js/900x500/auto/#666:#666" src="../../App_Style/images/banner/location/parkville.png">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tab-content">
                        <div class="tab-pane active" id="familycenterysparkville">
                                            ...
                                            <div style="height: auto;" class="panel-collapse in" id="collapse-how-to">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                <h3 class="title-03">Parkville Family Center Y</h3>
                                                                <address>
                                                                ...
                                                                <h3 class="title-03">Crystal Hahn</h3>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <a href="" class="img-thumbnail-box">
                                                                            <img class="img-thumbnail" src="../../App_Style/images/directors/Chrystal Hahncrp copy.jpg">
                                                                        </a>
                                                                    </div>
                                                                </div>

                                                                <ul>
                                                                    <li>Center Director/Membership Executive Director: <a href="mailTo:crystalhahn@ymaryland.org">Crystal Hahn</a></li>
                                                                    <li>Director of Membership & Program Development: <a href="mailTo:lesliedohler@ymaryland.org">Leslie Dohler</a></li>
                                                                    <li>Director of Member Services: <a href="mailTo:marychristinaduvall@ymaryland.org">Tina Duvall</a></li>
                                                                    <li>Swim & Family Director: <a href="mailTo:colleenmonaghan@ymaryland.org">Colleen Monaghan</a></li>
                                                                    <li>Director of Health & Well-being: <a href="mailTo:andrewcorbett@ymaryland.org">Andy Corbett</a></li>
                                                                    <li>Facility Director: <a href="mailTo:marvinhiggs@ymaryland.org">Marvin Higgs</a></li>
                                                                </ul>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                    <li>4 lane, 25 yard lap pool, 3.5 ft. to 5 ft. deep</li>
                                                                </ul>
                                                                <p><strong>State-of-the-Art Fitness Center  </strong></p>
                                                                <ul>
                                                                    <li>7,500 square feet </li>
                                                                ...
                                                                <ul>
                                                                    <li>Two group exercise studios for yogalates, Zumba and more </li>
                                                                    <li>Dedicated cycle studio </li>
                                                                    <li>Family room with foosball, air hockey, ping pong, computers, board games, TV and more </li>
                                                                    <li>Spacious lobby with comfortable seating </li>
                                                                    <li>Multipurpose program room with sport court </li>
                                                                    <li>Kid zone play structure </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>The Parkville Family Center Y offers a wide variety of programs including group exercise, swim lessons, water fitness, youth sports, drop-in workshops and more!</p>
                                                                <p><strong>Summer at the Y </strong></p>
                                                                <p>Y <a href="/programs/camps/camps.aspx">camp</a> is available in weekly sessions from June - August.</p>
                                                                <p><strong>Birthday Parties</strong></p>
                                                                <p>Celebrate your special day at the Y! Call 410-663-1300 for party themes, rates and more.</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5">
                                                            <div class="side-bar">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                    <li><a href="pdf/schedule/parkville-family-center-y/Parkville-HW.pdf" target="_blank">Group Exerise (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/parkville-family-center-y/Parkville-pool.pdf" target="_blank">Open/Lap Swim (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/parkville-family-center-y/Parkville-GroupExercise-Summer14.pdf" target="_blank">Group Exercise (summer)</a></li>
                                                                    <li><a href="pdf/schedule/parkville-family-center-y/Parkville-OpenLap-Pool-Summer14.pdf" target="_blank">Open/Lap Swim (summer)</a></li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <h3 class="title-03">Melissa Macefe</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/Melissa-Macefe-Parkville.jpg" />
                                                                <p><a href="mailto:melissamacefe@ymaryland.org; andrewcorbett@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                <p><strong>Philosophy:</strong>I believe fitness is attainable for everyone! </p>
                                                                <p><strong>Certifications:</strong> AAAI Group fitness instructor, AAAI Certified Personal Trainer</p>

                                                                <h3 class="title-03">Andy Corbett</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/Andy-Corbett-Parkville.jpg" />
                                                                <p><a href="mailto:andrewcorbett@ymaryland.org; andrewcorbett@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                <p><strong>Philosophy:</strong>Everyone can achieve their goals with a little hard work and determination.</p>
                                                                <p><strong>Specialties:</strong> Cardiac Rehab, Strength Training, Senior Fitness, Rehab, Weight Loss,  Youth Sports, High School Baseball & Soccer Conditioning, Cancer Programs</p>
                                                                <p><strong>Certifications:</strong> NASM Personal Trainer, Cancer Exercise Specialist</p>

                                                                <h3 class="title-03">Gregory Lee</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/Greg-Lee-Parkville.jpg" />
                                                                <p><a href="mailto:gregorylee@ymaryland.org; andrewcorbett@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                <p><strong>Philosophy:</strong>Become a healthier version of you!</p>
                                                                <p><strong>Certifications:</strong> NASM Personal Trainer, ISSA Personal Trainer</p>
                                                                ...
                                                                <p><a href="mailto:susanfioravante@ymaryland.org; andrewcorbett@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                ...
                                                                <h3 class="title-03">Beata Carnahan</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/Beata-Carnhan-Parkville.jpg" />
                                                                <p><a href="mailto:beatacarnahan@ymaryland.org; andrewcorbett@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                <p><strong>Philosophy:</strong>Staying fit helps you feel healthier, happier and more confident. I believe it is my job to encourage others to want a lifetime of health &fitness.</p>
                                                                <p><strong>Certifications:</strong> NASM Personal Trainer, R.I.P.P.E.D. Certified Instructor</p>
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <div class="side-bar">
                                                                <a onclick="SpecialRedirect('ptoneonone')" href="/programs/personal-training/personal-training.aspx" class="common-btn btn-velvet"><span class="btn-velvet-border">Learn More About Personal Training</span></a>
                                                                <%--<img src="../../App_Style/images/banner/side-bar/sidebar-banner.png" alt="sidebar banner">--%>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>If you're interested in becoming a volunteer, please contact Crystal Hahn at 410-663-1300 or <a href="mailTo:crystalhahn@ymaryland.org">crystalhahn@ymaryland.org</a> .</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5">
                                                            <div class="side-bar">
