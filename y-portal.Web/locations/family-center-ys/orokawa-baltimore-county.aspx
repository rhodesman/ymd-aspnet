<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.Master" AutoEventWireup="true" CodeBehind="orokawa-baltimore-county.aspx.cs" Inherits="YPortal.Web.locations.family_center_ys.orokawa_baltimore_county" %>
        ...
        <li data-slide-to="2" data-target="#carousel-example-captions" class=""> <a href="#messagess" data-toggle="tab"><img src="App_Style/images/banner/inner-page-banner/indicator-01.png"> <span> Youth Sports </span></a> </li>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <img alt="More than a  membership" data-src="holder.js/900x500/auto/#666:#666" src="../../App_Style/images/banner/location/OrkawaCenter.png">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tab-content">
                        <div class="tab-pane active" id="familycenterysorokawa">
                                            ...
                                            <div style="height: auto;" class="panel-collapse in" id="collapse-how-to">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                <h3 class="title-03">The Orokawa Family Center Y in Towson </h3>
                                                                <address>600 W. Chesapeake Ave.
                                                                    <br />
                                                                    Towson, MD 21204 </address>
                                                                <br class="clear" />
                                                                <p><i>Named for The Orokawa Foundation in honor of their sustained and generous support of the Y's mission.</i></p>
                                                                <p>410-823-8870</p>

                                                                <h3 class="title-03">Christie Ryan</h3>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <a href="" class="img-thumbnail-box">
                                                                            <img class="img-thumbnail" src="../../App_Style/images/directors/Christie-Ryan.png">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <ul>
                                                                    <li>District Executive Director: <a href="mailTo:christieryan@ymaryland.org">Christie Ryan</a></li>
                                                                    <li>Associate Center Director: <span style="color: #2489CA;">open position</span></li>
                                                                    <li>Director of Member Services: <a href="mailTo:celesteholthaus@ymaryland.org">Celeste Holthaus</a></li>
                                                                    <li>Senior Program Director: <a href="mailTo:maximbasin@ymaryland.org">Maxim Basin</a></li>
                                                                    <li>Fitness Director: <a href="mailTo:jeffanderson@ymaryland.org">Jeff Anderson</a></li>
                                                                    <li>Swim Director: <a href="mailTo:aliciacampbell@ymaryland.org">Alicia Campbell</a></li>
                                                                    <li>Facility Director: <a href="mailTo:frankholden@ymaryland.org">Frank Holden</a></li>
                                                                    <li>Program Director: <a href="mailTo:bethlentz@ymaryland.org">Beth Lentz</a></li>
                                                                </ul>
                                                                ...
                                                                <p>
                                                                    Mon-Fri: 8:30am - 1:00pm, 4:30pm - 8:00pm
                                                                    <br />
                                            ...
                                            <div style="height: auto;" class="panel-collapse in" id="collapse-features">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                <p><strong>Two Salt Water Pools</strong></p>
                                                                <ul>
                                                                    <li>Six lane, 25 yard lap pool </li>
                                                                ...
                                                                <ul>
                                                                    <li>8,000 square feet </li>
                                                                    <li>Cardio equipment with personal TV monitors </li>
                                                                    <li>Expresso bikes</li>
                                                                    <li>Cybex strength training machines</li>
                                                                    <li>Free weights</li>
                                                                    <li>FitLinxx (digital training partner that tracks your fitness progress)</li>
                                                                </ul>
                                                                <p><strong>Other Exciting Amenities  </strong></p>
                                                                <ul>
                                                                    <li>Group exercise studio for classes like Zumba, cardio blast and more </li>
                                                                    <li>Dedicated cycle studio</li>
                                                                    <li>Rock climbing wall</li>
                                                                    <li>Family room with foosball, air hockey, board games, TV and more</li>
                                                                    <li>Health bar serving delicious smoothies, sandwiches and salads</li>
                                                                    <li>Spacious lobby with comfortable seating and stone fireplace</li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>The Orokawa Family Center Y in Towson is a full service Y that offers a wide variety of classes including group exercise, swim lessons, water fitness, youth sports, martial arts, drop-in workshops and more!</p>
                                                                <p><strong>Summer at the Y      </strong></p>
                                                                <p>Y <a href="/programs/camps/camps.aspx">camp</a>, summer <a onclick="SpecialRedirect('sportsclinics')" href="/programs/sports/sports.aspx">sports clinics</a> and <a onclick="SpecialRedirect('swimclinics')" href="/programs/swim/swim.aspx">swim clinics</a> are available in weekly sessions from June - August. </p>

                                                                <p><strong>Preschool   </strong></p>
                                                                <p>
                                                                    <a href="/programs/preschool/preschools.aspx">Y preschool in Towson</a> brings learning and fun together in a nurturing environment where children thrive. 
                                                                </p>
                                                                <p><strong>Before & After School Enrichment   </strong></p>
                                                                <p>
                                                                    Y <a href="/programs/before-and-after-school-programs/before-and-after-school-programes.aspx">before & after school enrichment</a> programs gives children a safe haven of fun and discovery. Program conveniently located inside St. Joseph's Catholic School. 
                                                                </p>
                                                                <p><strong>Youth & Government </strong></p>
                                                                <p>
                                                                    Y <a onclick="SpecialRedirect('baaspgovernment')" href="/programs/before-and-after-school-programs/before-and-after-school-programes.aspx">Youth & Government</a> educates high school students about the democratic and legislative process including writing bills, debating, campaigning and parliamentary procedure. Includes an annual trip to the State Capital in Annapolis, MD to participate in a mock legislative session. 
                                                                </p>

                                                                <p><strong>Birthday Parties   </strong></p>
                                                                <p>Celebrate your special day at the Y! Call 410-823-8870 for party themes, rates and more!</p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-HW-Spring-2-2014.pdf" target="_blank">Group Exerise (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-Main-Pool-spring-II-14.pdf" target="_blank">Lap Pool (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-Family-Pool-spring-II-14.pdf" target="_blank">Family Fun Pool (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-Gym-Schedule-Side-A-SpringII-2014.pdf" target="_blank">Gym A (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-Gym-Schedule-Side-B-SpringII-2014.pdf" target="_blank">Gym B (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-GroupExercise-Summer14.pdf" target="_blank">Group Exercise (summer)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-FamilyPool-Summer14v2.pdf" target="_blank">Family Pool (summer)</a></li>
                                                                    <li><a href="pdf/OrokawaMainPoolSummer14v2.pdf" target="_blank">Lap Pool (summer)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-GymA-Summer14.pdf" target="_blank">Gym A (summer)</a></li>
                                                                    <li><a href="pdf/schedule/orokawa-family-center-y/Orokawa-GymB-Summer14.pdf" target="_blank">Gym B (summer)</a></li>
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <h3 class="title-03">Amy Nesspor</h3>
                                                                    <img class="img-thumbnail" src="../../App_Style/images/personal-training/Amy-Nesspor-Orokawa.jpg" />
                                                                    <p><a href="mailto:AmyNesspor@ymaryland.org; jeffanderson@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                    <p><strong>Philosophy:</strong>I believe fitness is attainable for everyone.</p>
                                                                    <p><strong>Certifications:</strong> Y Certified Personal Trainer, Y Certified Group Exercise Instructor, Certified Spinning Instructor, Les Mills BodyPump, CXWorX, TRX & Trigger Point Performance Therapy </p>

                                                                    <h3 class="title-03">Julie Gleeson</h3>
                                                                    <img class="img-thumbnail" src="../../App_Style/images/personal-training/Julie-Gleeson-Orokawa.jpg" />
                                                                    <p><a href="mailto:juliegleeson@ymaryland.org; jeffanderson@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                    <p><strong>Philosophy:</strong>Being fit can be attained at any age!  I believe fitness should be fun and motivating. </p>
                                                                    <p><strong>Certifications:</strong> Y Certified Personal Trainer, Y Certified Group Exercise Instructor</p>

                                                                    <h3 class="title-03">Ivan Rodriguez</h3>
                                                                    <img class="img-thumbnail" src="../../App_Style/images/personal-training/Ivan-Rodriquez-Orokawa.jpg" />
                                                                    <p><a href="mailto:IvanRodriguez@ymaryland.org; jeffanderson@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                    <p><strong>Philosophy:</strong>Achieving your fitness goals isn’t easy. It takes patience and perseverance.  I try to provide each client with a specific, goal-oriented plan to reach their goals. </p>
                                                                    <p><strong>Specialties:</strong> Sports Performance Training, Strength Training, Weight Loss Management</p>
                                                                    <p><strong>Certifications:</strong> : NSCA Certified Strength & Conditioning Specialist, USAW Certified Level 1 Sports Performance Coach, Y Certified Personal Trainer</p>

                                                                    <h3 class="title-03">Glenn Egbert</h3>
                                                                    <img class="img-thumbnail" src="../../App_Style/images/personal-training/GlennEgbert-Orokawa.jpg" />
                                                                    <p><a href="mailto:GlennEgbert@ymaryland.org; jeffanderson@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>
                                                                    <p><strong>Philosophy:</strong>I believe health and well-being is a lifetime endeavor and no one is too young or too old to benefit.</p>
                                                                    <p><strong>Specialties:</strong> Weightlifting, Power Lifting</p>
                                                                    ...
                                                                    <p><a href="mailto:margretarempert@ymaryland.org; jeffanderson@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a> </p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>If you're interested in becoming a volunteer, please contact Christie Ryan at 410-823-8870 or christieryan@ymaryland.org.</p>
