<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.Master" AutoEventWireup="true" CodeBehind="weinberg-baltimore-city.aspx.cs" Inherits="YPortal.Web.locations.family_center_ys.weinberg_baltimore_city" %>
        ...
        <li data-slide-to="2" data-target="#carousel-example-captions" class=""> <a href="#messagess" data-toggle="tab"><img src="App_Style/images/banner/inner-page-banner/indicator-01.png"> <span> Youth Sports </span></a> </li>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <img alt="More than a  membership" data-src="holder.js/900x500/auto/#666:#666" src="../../App_Style/images/banner/location/weinberg.png">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tab-content">
                        <div class="tab-pane active" id="familycenterysweinberg">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <address>
                                                                    900 E. 33rd St.  <br />    Baltimore, MD 21218
                                                                </address>
                                                                <br class="clear" />
                                                                <p>410-889-9622</p>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <a class="img-thumbnail-box" href="">
                                                                            <img src="../../App_Style/images/directors/eric-summer.png" class="img-thumbnail">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <ul>
                                                                    <li>District Executive Director: <a href="mailTo:ericsomerville@ymaryland.org">Eric Somerville</a></li>
                                                                    <li>Associate Center Director: <a href="mailTo:danielguyton@ymaryland.org">Dan Guyton</a></li>
                                                                    <li>Director of Membership & Program Development: <a href="mailTo:annvachon@ymaryland.org"> Ann Vachon</a></li>
                                                                    <li> Youth, Teen & Events Director: <a href="mailTo:alexisperkins@ymaryland.org">Alexis Perkins</a></li>
                                                                    <li>Director of Sports: <a href="mailTo:rebeccawinslow@ymaryland.org">Rebecca Winslow</a></li>
                                                                ...
                                                                <p>Mon-Fri: 5:30am - 10:00pm  <br />      Sat: 7:00am - 7:00pm     <br />             Sun: 9:00am - 7:00pm</p>
                                                                <p><strong>Stay & Play Hours</strong></p>
                                                                <p>Mon-Fri: 8:30am - 1:00pm, 5:00pm - 8:00pm     <br /> Sat: 9:00am - 12:30pm</p>
                                                           
                                                                    <p><strong>Holiday Hours</strong></p>

                                                                     <p>New Year's Eve: 5:30am - 2:00pm  
                                                                    <br />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                    <li>4 lanes, 25 yard lap pool, 3 ft. to 5 ft. deep</li>
                                                                </ul>
                                                                
                                                                <p><strong>State-of-the-Art Fitness Center</strong></p>
                                                                <ul>
                                                                    <li>6,600 square feet</li>
                                                                ...
                                                                <ul>
                                                                    <li>Group exercise studio for boot camp, zumba, cycle and more</li>
                                                                    <li>Double gymnasium </li>
                                                                    <li>Rock climbing wall </li>
                                                                    <li>Family room with foosball, ping pong, air hockey, board games, TV and more </li>
                                                                    <li>Ripken Youth Ball Field </li>
                                                                    <li>Stadium Place community-built playground</li>
                                                                    <li>Spacious lobby with comfortable seating </li>
                                                                    <li>Snack bar with delicious sandwiches, salads and more </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>The Weinberg Family Center Y is a full service Y that offers a wide variety of programs including group exercise, swim lessons, water fitness, youth sports, martial arts, drop-in workshops and more!</p>
                                                                ...
                                                                <p>
                                                                    <a href="../preschool/weinberg-baltimore-city.aspx">Y Preschool at Weinberg</a> brings learning and fun together in a nurturing environment where children thrive. 
                                                                </p>

                                                                <p><strong>Birthday Parties  </strong></p>
                                                                <p>Celebrate your special day at the Y! Call 410-889-9622 for party themes, rates and more!</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5">
                                                            <div class="side-bar">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <ul>
                                                                   <%-- <li><a href="pdf/schedule/weinberg-family-center-y/Weinberg-Gym-2014-Spring-II.pdf" target="_blank">Group Exercise Gym</a></li>  
                                                                    <li><a href="pdf/schedule/weinberg-family-center-y/Weinberg-Pool-2014-Spring-II.pdf" target="_blank">Group Exercise Pool</a></li> --%>                                                                                                                                                                                                                                                                                                                
                                                                    <li><a href="pdf/schedule/weinberg-family-center-y/Weinberg-hw-2014-SpringII.pdf" target="_blank">Group Exercise (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/weinberg-family-center-y/Weinberg OpenLapSwim Summer'14.pdf" target="_blank">Open/Lap Swim (spring II)</a></li>
                                                                    <li><a href="pdf/schedule/weinberg-family-center-y/Weinberg-Gym-2014-SpringII.pdf" target="_blank">Open Gym (spring II)</a></li>
                                                                    <li><a href="pdf/Weinberg-GroupExercise-Summer_14.pdf" target="_blank">Group Exercise (summer)</a></li>
                                                                    <li><a href="pdf/WeinbergOpenLapSwimSummer14.pdf">Open/Lap Swim (summer)</a></li>
                                                                    <li><a href="pdf/Weinberg-OpenGym-Summer_14.pdf" target="_blank">Open Gym (summer)</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <h3 class="title-03">Linda Smith</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/LindaSmith-Weinberg.jpg"/>
                                                                <p><a href="mailto:LindaSmith@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>                                                                
                                                                <p><strong>Philosophy:</strong>My goal is to encourage, tohave compassion, to have strength, to enable you to do the best you can.</p>
                                                                <p><strong>Certifications:</strong> Y Personal Training, NASM Personal Trainer – in progress</p>

                                                                <h3 class="title-03">D. Amaadi Coleman</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/DAmaadiColeman-Weinberg.jpg"/>
                                                                <p><a href="mailto:amaadicoleman@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>                                                                
                                                                <p><strong>Philosophy:</strong>Through my love for music and dance, I keep adults and children active and help them achieve their fitness goals.</p>
                                                                <p><strong>Certifications:</strong> Y Personal Training, ACE Personal Training – in progress</p>

                                                                <h3 class="title-03">Derrick (DJ) Johnson</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/Derrick(DJ)Johnson-Weinberg.jpg"/>
                                                                <p><a href="mailto:derrickjohnson@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>                                                                
                                                                <p><strong>Philosophy:</strong>Helping people improve their health & fitness means the world to me and I dedicate all of my training knowledge to the clients and athletes who are aspiring toward higher goals.</p>
                                                                <p><strong>Specialties:</strong> Specialties: Sports-specific Training, Weight Loss, Body Composition</p>
                                                                <p><strong>Certifications:</strong> ACE Personal Training</p>

                                                                <h3 class="title-03">Raechelle Floyd</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/RaechelleFloyd-Weinberg.jpg"/>
                                                                <p><a href="mailto:RaechelleFloyd@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>                                                                
                                                                <p><strong>Philosophy:</strong>To train with safe and effective exercise principles.</p>
                                                                <p><strong>Specialties:</strong> Strength, Toning, Rehabilitation.</p>
                                                                <p><strong>Certifications:</strong> AAAI/ISMA Personal Training.</p>

                                                                <h3 class="title-03">Alice Lium</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/Alice-Lium-Weinberg.jpg"/>
                                                                <p><a href="mailto:AliceLium@ymaryland.org; margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>                                                                
                                                                <p><strong>Philosophy:</strong>I welcome people just starting to exercise and those with limitations. Let's enjoy moving in a way that helps us become healthier, stronger, more flexible and happier!</p>
                                                                <p><strong>Certifications:</strong> Y-certified personal trainer, ACE personal trainer – in progress</p>

                                                                <h3 class="title-03">Danielle Sullivan</h3>
                                                                <img class="img-thumbnail" src="../../App_Style/images/personal-training/DanielleSullivan-Weinberg.jpg"/>
                                                                <p><a href="mailto:daniellesullivan@ymaryland.org;margretarempert@ymaryland.org"><strong>Inquire About Personal Training</strong></a></p>                                                                
                                                                <p><strong>Philosophy:</strong>A strong and healthy mind, body and heart enable you to achieve your goals and grow a positive outlook and courage.</p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7">
                                                            <div class="main-body">
                                                                ...
                                                                <p>The primary responsibility of CLB members is to help engage the community in the Y's charitable mission to support children and families in need in Baltimore City so they may benefit from quality Y experiences they otherwise couldn't afford.</p>                                                                         </p>
                                                                
                                                                <p>If you're interested in becoming a volunteer, please contact Eric Somerville at 410-889-9622 or ericsomerville@ymaryland.org.</p> 
