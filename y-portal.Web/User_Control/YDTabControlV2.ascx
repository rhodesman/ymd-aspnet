<%@ Control Language="C#"
    ...
    CodeBehind="YDTabControlV2.ascx.cs"
    Inherits="YPortal.Web.User_Control.YDTabControlV2" %>
                ...
                <div class="tab-pane active" id="Overview" runat="server">


                    <div class="content-area-bg">

                        <ul class="nav nav-tabs responsive hidden-xs hidden-sm" id="myTab">
                            <li class="active"><a href="#home" class="" data-toggle="tab">PNL1</a></li>
                            <li><a href="#home2" class="" data-toggle="tab">PNL2</a></li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="home">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#collapse-how-to" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">AFFORDABLE SUMMER FUN</a>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    ...
                                                    <div class="side-bar">
                                                        <a href="registernow.aspx" onclick="SpecialRedirect('campsregistration')" class="common-btn btn-velvet">
                                                            <span class="btn-velvet-border">How to Register</span>
                                                        </a>
                    ...
                    <div class="content-area-bg">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="campsprofilesanne">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-tab-02" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">ANNE ARUNDEL COUNTY </a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="campsprofilesbaltimorecity">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-tab-03" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">BALTIMORE CITY</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="campsprofilesbaltimore">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-tab-04" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">BALTIMORE COUNTY</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="campsprofilescarroll">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-tab-05" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">CAROLL COUNTY &amp; OVERNIGHT CAMP</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="campsprofilesharford">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-tab-06" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">HARFORD COUNTY</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
...
Science Camps - Environmental Explorers, Jolts &amp; Volts, Weird Science
                            ...
                            <div class="tab-pane " id="campsprofileshoward">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-tab-07" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">HOWARD COUNTY</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                ...
                <div class="tab-pane" id="Options__And__Fees">
                    <div class="content-area-bg">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="sub-tab-10">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-11" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">YOUTH CAMPS</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-11">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-12" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">TEEN CAMPS
                                        </a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-12">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-13" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">CAROLL COUNTY CAMP
                                        </a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-13">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-14" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">OVERNIGHT CAMP</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-14">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-15" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">SPECIALTY CAMP</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-15">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-16" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">SUMMER LEARNING FOR PRESCHOOLERS</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                ...
                <div class="tab-pane" id="Themes_cm__Trips__And__Events">
                    <div class="content-area-bg">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="sub-tab-20">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-tab-20" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">A JOURNEY TO REMEMBER</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                                        ...
                                                        <table class="table table-striped">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <strong>Brazil, Argentina, Peru </strong>- Join us for the world's largest South American carnival as you samba across this vast land learning about this amazing culture! <strong>Special Event: Y Carnival
                                                                        </strong>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                ...
                <div class="tab-pane" id="General_Info__And__Forms">
                    <div class="content-area-bg">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="sub-tab-30">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-30" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">ACA ACCREDITED</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-31">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-31" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">CAMP AVAILABILITY &amp; HOURS</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-32">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-32" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">DEPOSITS, FEES &amp; SIBLING DISCOUNTS</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="sub-tab-33">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-33" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">FAQS</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="tab-pane " id="brochuresformsmanuals">
                                <div class="panel-heading visible-xs visible-sm">
                                    <div class="panel-title">
                                        <a href="#mob-sub-tab-34" data-parent="#collapse-myTab" data-toggle="collapse" class="accordion-toggle deco-none misc-class">BROCHURE, FORMS &amp; MANUALS</a>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="main-body">
                                                        ...
                                                        <ul>
                                                            <li><a href="pdf/CampParentManual2014fnlv2.pdf" target="_blank">2014 Y Camp Parent Manual</a></li>
