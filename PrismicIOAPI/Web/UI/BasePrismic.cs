...
{
    public class BasePrismic : WebControl
    {
        #region Fields
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        protected virtual object GetContent(string id)
        {
          var contentController = new ContentController();
          return contentController.Get(id) as List<prismic.Api.Document>;
        ...
        protected prismic.Api.Document GetDocument(string AssetId, string  AssetType)
        {
            ...
            var documents = GetContent(query) as List<prismic.Api.Document>;
